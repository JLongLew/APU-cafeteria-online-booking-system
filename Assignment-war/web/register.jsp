...
<html>
    <head>
        ...
        <title>Register Page | EPDA Online Booking System</title>
    ...
    <body>
        <div class="container mx-auto p-4 bg-white">
            <div class="w-full md:w-1/2 lg:w-1/3 mx-auto my-12">
                ...
                <form class="flex flex-col mt-4" method="POST" action="/Assignment-war/register">
                    <input
                        type="text"
                        name="username"
                    ...
                    <div class="flex flex-col items-center mt-5">
                        <p class="mt-1 text-xs font-light text-gray-500">
                            Register already?<a class="ml-1 font-medium text-blue-700" href="/Assignment-war/login.jsp">Sign in now</a>
                        </p>
                    </div>
                </form>
            </div>
