<%-- 
    Document   : changerole
    Created on : Aug 5, 2022, 4:52:58 PM
    Author     : sunny
--%>
...
<html>
    ...
    <body>
        ...
        <form method="POST" action="/Assignment-war/editprofile">
        ...
        <c:if test="${editor eq 'manager'}">
            <c:if test="${nuser.role != 'manager'}">
                <a href="/Assignment-war/manageuser"><button>Back</button></a>
            </c:if>
            <c:if test="${nuser.role == 'manager'}">
                <a href="/Assignment-war/"><button>Back</button></a>
            </c:if>
        </c:if>
