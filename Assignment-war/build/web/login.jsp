<%-- 
    Document   : login
    Created on : Aug 4, 2022, 6:50:37 PM
    Author     : sunny
--%>
...
<html>
    <head>
        ...
        <title>Login Page | EPDA Online Booking System</title>
    ...
    <body>
        <section class="h-screen">
            <div class="container px-6 py-12 h-full">
                <h1 class="font-medium leading-tight text-5xl mt-0 mb-2 text-blue-600 text-center"> EPDA Online Booking System </h1>
                <div class="flex justify-center items-center flex-wrap h-full g-6 text-gray-800">
                    ...
                    <div class="md:w-8/12 lg:w-5/12 lg:ml-20">
                        <form method="POST" action="/Assignment-war/login">
                            <!--Email input--> 
                            <div class="mb-6">
                                <input
                                    type="text"
